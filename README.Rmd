...
# install font from package (false because rockwell not in package)
if(params$install_font) {
  sysfonts::font_add(
    family = params$font,
    regular = system.file(
...
The goal of ``r params$package`` is to provide helpful functions for the Roe Lab at Washington University in Saint Louis.
